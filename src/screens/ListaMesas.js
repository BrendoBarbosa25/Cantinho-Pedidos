...
// Recarrega toda vez que a tela ganha foco — importante ao voltar
  ...
  // useFocusEffect: hook do react native. Ele roda o codigo de dentro dele toda vez que a tela fica visível.
  useFocusEffect(
    // useCallback: Ele memoriza a função para que ela não seja recriada sem necessidade a cada renderização da tela.
    useCallback(() => {
      carregarDados();
